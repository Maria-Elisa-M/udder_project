...
# directories 
wd <- "C:/Users/marie/rep_codes/udder_project/paper/revision_B"
setwd(wd)
...
write.csv(merged_coef, "C:\\Users\\marie\\rep_codes\\udder_project\\paper\\revision_B\\tables\\merged_coef.csv", row.names = FALSE)
write.csv(merged_pv, "C:\\Users\\marie\\rep_codes\\udder_project\\paper\\revision_B\\tables\\merged_pv.csv", row.names = FALSE)
write.csv(merged_error, "C:\\Users\\marie\\rep_codes\\udder_project\\paper\\revision_B\\tables\\merged_error.csv", row.names = FALSE)
