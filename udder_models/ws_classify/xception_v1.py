# -*- coding: utf-8 -*-
"""
Created on Sun Feb  4 12:00:46 2024
...
#%% 
path = os.getcwd()
path = os.path.join(path, "ws_mask", "data")
...
#%%
pred_df = pd.DataFrame(index = range(len(test_images)), columns = ['filename', "p_bad", "p_good", "pred", "true"])
pred_df["filename"] = [im.split("/")[1] for im in test_images]
pred_df[["p_bad", "p_good"]] = predictions
